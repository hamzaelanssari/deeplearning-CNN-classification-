...
public class IrisApp {
    ...
    int numIn=4;int numOut=3; int nHidden=10;
    int classIndex=4;
    ...
    model.init();
        ...
        String filePathTrain=new ClassPathResource("Iris/iris_train.csv").getFile().getPath();
       ...
       for(int i=0;i<nEpochs;i++) {
        ...
        String filePathTest=new ClassPathResource("Iris/irisTest.csv").getFile().getPath();
