...
public class CNNModel {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        File fileTrain = new File("src/main/resources/mnist_png/training");
        ...
        File fileTest = new File("src/main/resources/mnist_png//testing");
        ...
        ModelSerializer.writeModel(model,"ModelNumbers.CNNModel-MNIST.zip",true);
